...
def overlay_two_figures(title, figure_1, figure_2, figure_1_type, figure_2_type, y_axis_range=None, should_save_to_html=False):
    """
    ...
    if should_save_to_html:
        overlayed_fig.write_html(f'{title}_overlay.html')
